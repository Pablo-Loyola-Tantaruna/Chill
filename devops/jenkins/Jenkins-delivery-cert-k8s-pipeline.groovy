...
def aksRG = "RSGREU2ZETFUXBC01"
//for AKS Cluster Name, for anything else: def aksCluster = ""
def aksCluster = "AKSREU2ZETFUXBD01"
//Ingress information for AKS
def ingressFQDN = "azingresszetfuxcer.perzet.com"
def ingressCertificateSecret = "azingresszetfuxcer-cert"
//registry for AKS
def registry = "azingresszetfuxcer.azurecr.io"
try {
    node {
        stage('Preparation') {
