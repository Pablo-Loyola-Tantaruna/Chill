...
def aksRG = "RSGREU2ZETFUXBD01"
//for AKS Cluster Name, for anything else: def aksCluster = ""
def aksCluster = "AKSREU2ZETFUXBD01"
//Ingress information for AKS
def ingressFQDN = "azingresszetfuxdev.perzet.com"
def ingressCertificateSecret = "azingresszetfuxdev-cert"
//registry for AKS
def registry = "azingresszetfuxdev.azurecr.io"
try {
    node {
        stage('Preparation') {
