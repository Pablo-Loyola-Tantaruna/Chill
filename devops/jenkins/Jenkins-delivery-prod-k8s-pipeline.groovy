...
// Project settings
def project = "ZETA_FUXT"
// Namespace settings
def namespace = "ZETA_FUXT"
// Mail configuration
...
def aksRG = "RSGREU2ZETFUXBP01"
//for AKS Cluster Name, for anything else: def aksCluster = ""
def aksCluster = "AKSREU2ZETFUXBP01"
//Ingress information for AKS
def ingressFQDN = "azingresszetfuxprod.perzet.com"
def ingressCertificateSecret = "azingresszetfuxprod-cert"
//registry for AKS
def registry = "azingresszetfuxprod.azurecr.io"
try {
    node {
        stage('Preparation') {
        ...
        stage('Application Delivery') {
            utils.setDeltaInit()
            utils.downloadSingleFilefromRepo("ZETA_FUXT", "maintenance-tasks", "develop", "github-token-${deploymentEnvironment}",
